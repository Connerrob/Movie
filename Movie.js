const options = {
  ...
  headers: {
    ...
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2M2JhZTc0OTQ2Mzg1MzA0OTE2ZWViYThmMzYxZTYzOCIsInN1YiI6IjY0NzM3MDk4OTQwOGVjMDBhN2ZhZDVkMSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Hd_EzZqHP11ygSre1R2tv6kLIvq5k4cqy8m2VXQDTWI",
  },
};
...
fetch("https://api.themoviedb.org/3/discover/movie?api_key=63bae74946385304916eeba8f361e638")
...
fetch(
  ...
  .then((data) => {
    ...
    // Process and display the upcoming movies data as desired
  })
  .catch((error) => {
